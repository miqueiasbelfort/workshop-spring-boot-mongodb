package com.miqueiasbelfort.workshopmongo.resources.exceptions;
...
public class ResourceExceptionHandler{
	...
	public ResponseEntity<StandardError> ResourceNotFoundException(ObjectNotFoundException e, HttpServletRequest request){
